<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-200 leading-tight">{{ __('Tambah Penyakit') }}</h2>
    </x-slot>
                    ...
                    <div class="mb-6 border-b border-gray-700 pb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" 
                                ...
                                required placeholder="Contoh: Diabetes Melitus">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="3" 
                                class="w-full bg-gray-900 border-gray-600 text-white rounded focus:ring-emerald-500 focus:border-emerald-500"
                                placeholder="Jelaskan secara singkat...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        <div class="flex flex-col sm:flex-row justify-between items-end mb-4 gap-4">
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">Silakan tentukan pantangan untuk penyakit.</p>
                            </div>
                            ...
                            <div class="w-full sm:w-64 relative">
                                ...
                                <input type="text" id="searchIngredient" class="block w-full p-2.5 pl-10 text-sm text-gray-200 border border-gray-600 rounded-lg bg-gray-700 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 placeholder-gray-400 transition-colors" placeholder="Cari bahan...">
                            </div>
                        </div>
                        ...
                        <div id="ingredientGrid" class="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
                            @foreach($ingredients as $ingredient)
                                <div class="ingredient-item flex items-center justify-between bg-gray-900 p-3 rounded border border-gray-600 hover:border-gray-500 transition">
                                    ...
                                    <select name="ingredients[{{ $ingredient->id }}]" class="bg-gray-800 border-gray-600 text-sm rounded focus:ring-emerald-500 focus:border-emerald-500 ml-2 text-gray-400">
                                        <option value="" selected>-- Netral --</option>
                                        <option value="safe">✅ Aman</option>
                                        <option value="warning">⚠️ Batasi</option>
                        ...
                        @if($ingredients->isEmpty())
                             <p class="text-red-400 text-sm mt-2 text-center border border-red-900 p-2 rounded bg-red-900/20">*Belum ada Data Bahan Makanan. Silakan input bahan dulu.</p>
                        @endif
                    </div>

                    <div class="flex justify-end gap-2 mt-6 border-t border-gray-700 pt-4">
                        <a href="{{ route('admin.diseases.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-500 transition">Batal</a>
                        <button type="submit" class="px-6 py-2 bg-emerald-600 text-white rounded hover:bg-emerald-700 font-bold shadow-lg transition">Simpan Data</button>
                    </div>
                </form>
